    ...
    return(
        ...
        <div className="relative h-full">
            ...
            <div className="w-full transition-2 left-8 absolute top-36">
                    <div id="line" className="w-full animate-line bg-gradient-to-r from-lime-600 from-50% via-lime-500 via-80% to-lime-300  p-px  rounded-sm rotate-90 origin-left transition-2">
